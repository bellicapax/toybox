...
var chestToyboxPlugin = {
  ...
  sfx: ["chestOpen"],
    ...
    var chestCollide = function(chest, collidedSprite){
      ...
      var keyIsPresent = ((collidedSprite == this.key) || (collidedSprite.children.indexOf(this.key) != -1));
    ...
    chestGO.closed = true;
    chestGO.locked = typeof ((chestOptions.locked) == "undefined") ? false : chestOptions.locked;
